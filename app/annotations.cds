using { sunminJeon_1_23Srv } from '../srv/service.cds';

annotate sunminJeon_1_23Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Message', Title: { Value: customerMessageID } };
annotate sunminJeon_1_23Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate sunminJeon_1_23Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate sunminJeon_1_23Srv.CustomerMessage with {
...
annotate sunminJeon_1_23Srv.CustomerMessage with @UI.LineItem: [
...
annotate sunminJeon_1_23Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate sunminJeon_1_23Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate sunminJeon_1_23Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
